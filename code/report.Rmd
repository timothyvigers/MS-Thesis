...
```{r echo=FALSE}
load("./data/networks/perm_structs_test.Rdata")
best_perm_structs = unlist(lapply(perm_structs, which.min))
hist(best_perm_structs,xlab = "Structure",
     main = "Histogram of How Often Network Structure Is Selected")
```
