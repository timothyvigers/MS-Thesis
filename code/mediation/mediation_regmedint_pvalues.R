...
methyl_psv_pvalues = parApply(cl,methyl_psv_candidates,1,function(r){
...
rownames(methyl_psv_pvalues) = apply(methyl_psv_candidates,1,paste,collapse = " & ")
# Save
save(methyl_psv_pvalues,file = "./data/mediation/methyl_psv_candidate_pvalues.Rdata")
stopCluster(cl)
# Same again for metab at PSV
# Iterate through all - parallel
cl = makeCluster(cores,type = "FORK")
metab_psv_pvalues = parApply(cl,metab_psv_candidates,1,function(r){
  methyl = as.character(r[1])
  methyl = as.numeric(scale(psv[,methyl]))
  metab = as.character(r[2])
  metab = as.numeric(scale(sv[,metab]))
...
rownames(metab_psv_pvalues) = apply(metab_psv_candidates,1,paste,collapse = " & ")
# Save
save(metab_psv_pvalues,file = "./data/mediation/metab_psv_candidate_pvalues.Rdata")
stopCluster(cl)