...
Distibution of p values looks reasonable across permutations. The omnibus p value is elevated because it's simply the highest of the four others.
...
cits = apply(pairs, 1, function(x){
  ...
  o = which.min(c(cinf1$p_cit,cinf2$p_cit))
  o = ifelse(o == 1,">","<")
  if (p < 0.05) {return(paste(methyl,metab,p,o))} else {NA}
})
# Convert to dataframe
cits = as.data.frame(cits[!is.na(cits)])
cits = separate(cits,"cits[!is.na(cits)]",c("methyl","metab","cit p","direction"),
                sep = " ")
