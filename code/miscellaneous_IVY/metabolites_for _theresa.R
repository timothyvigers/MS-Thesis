...
lipid_anno = read.csv("~/Documents/School/MS Thesis/data/raw_data/lipid.featureAnno.csv")
matches = lipid_anno$feature_name[unique(grep(paste(metabs,collapse="|"),lipid_anno$Metabolite.name))]
lipids = read.csv("~/Documents/School/MS Thesis/data/raw_data/lipid.bc.csv")
sample = read.csv("~/Documents/School/MS Thesis/data/raw_data/ivyomicssample_noIdentifyingInfo.csv")
