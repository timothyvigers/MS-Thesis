...
knitr::opts_knit$set(root.dir = "~/Documents/School/Statistical Genomics/EWAS/results/late_infancy")
```
...
```{r plot functions}
manhattan_plot = function(df,p,annotate = NULL){
  y = sym(p)
...
man$chr = as.numeric(sub("chr","",man$chr))
# manhattan_plot(man,p = "id_wbr.4.months.P",annotate = "cg26245086")
