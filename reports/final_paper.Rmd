...
# One row per pair
t = res %>% pivot_wider(values_from = c("Type","Description"),
...
## Supplemental Figure 1: Correlation Heatmaps
...
methyl_psv_heat = pheatmap(m,show_rownames = F,show_colnames = F,
         main = "DNAm at PSV and Metabolite at SV")
# Second
...
metab_psv_heat = pheatmap(m,show_rownames = F,show_colnames = F,
         main = "Metabolite at PSV and DNAm at SV")
```
