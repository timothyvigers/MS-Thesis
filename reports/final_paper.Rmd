...
The Diabetes Autoimmunity Study in the Young (DAISY) cohort follows 2547 high-risk children in Colorado for the development of IA and T1D. The study follows participants prospectively and includes blood sample collection at 9, 15, and 24 months, then annual collection until islet autoimmunity (IA) is detected. IA seroconversion (SV) is defined as the second consecutive visit at which a confirmed autoantibody to insulin, GAD65, IA-2, or ZnT8 was detected (Figure 1).[@johnsonMetaboliterelatedDietaryPatterns2019] Participants who develop IA are asked to follow an accelerated protocol with visits and blood sample collection every 3-6 months, until they are diagnosed with diabetes by a physician. Thus, DAISY's study design allows us to include exposure and mediator variables that are temporally separated in our mediation models because methylation was measured prior to seroconversion [PSV] and metabolite was measured at seroconversion [SV] (and vice versa). This aids in interpretation of the results and in theory does not violate the assumptions of a mediation analysis. 
...
Pathway over-representation was examined the top 100 probes using PANTHER's[@miPANTHERVersion162021] implementation of Reactome pathways[@fabregatReactomePathwayKnowledgebase2018]. These p values were based on standard error of NIE estimated using the multivariate delta method.[@vanderweeleExplanationCausalInference2015] CpG sites were converted to Entrez IDs using the missMethyl R package[@phipsonMissMethylPackageAnalyzing2016a] and the 199,243 original probes were used as the reference list. Pathways with less than 5 genes in the reference list and less than two genes in analysis list were excluded.
...
![](/Users/timvigers/Dropbox/School/MS Thesis/images/fig1.png)
...
We found seven unique pairs of DNAm probes and metabolites with significant natural indirect mediation effects. For all seven pairs, metabolite was positively associated with IA, and DNAm was negatively associated with both the metabolite and IA. Thus, an indirect effect less than one suggests that some of the protective effect of the DNAm probe is via reduction of the metabolite.
...
This study has identified several potential causal pathways in the etiology of IA. The seven methylation sites that were significantly mediated by metabolites are potentially interesting candidates for better understanding epigenetic protection against T1D. While the causal pathways in our mediation models are temporally reasonable in the sense that the exposure was measured prior to the mediator, a better understanding of the biological pathways is necessary to confirm these exploratory analyses.

# Limitations

Metabolites were measured in non-fasting samples, and these analyses did not account for dietary intake, which is the single biggest source of exposure to chemicals and nutrients.[@jonesNutritionalMetabolomicsProgress2012] Enrichment and over-representation tools are not designed for the integration of methylation and metabolomics data and are likely not an ideal guide for biological interpretation of our results. Also, we did not adjust the candidate selection step for multiple testing, and only adjusted p values at the second stage, which could potentially bias the results. However, the best approach to p value adjustment for correlated variables in this filtering step remains an active area of statistical research and we suggest that this approach is unlikely to result in many false positives due to the adjustments used in the later stages.[@rudraPredictiveModelingMiRNAmediated2018]
