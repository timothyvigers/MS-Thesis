...
bibliography: "/home/tim/.local/share/Cryptomator/mnt/Vault/Miscellaneous/references.bib"
csl: "/home/tim/.local/share/Cryptomator/mnt/Vault/Miscellaneous/multidisciplinary-digital-publishing-institute.csl"
output: word_document
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = FALSE,dpi = 600)
knitr::opts_knit$set(root.dir = "/home/tim/.local/share/Cryptomator/mnt/Vault/School/MS Thesis")
library(rjson)
...
![](/home/tim/.local/share/Cryptomator/mnt/Vault/School/MS Thesis/images/fig1.jpg)
...
methyl_psv_heat = pheatmap(m,show_rownames = F,show_colnames = F,main = "a",
                           legend_labels = c("0.3","0.2","0.1","0","–0.1","–0.2","–0.3"),
                           legend_breaks = c(0.3,0.2,0.1,0,-0.1,-0.2,-0.3))
ggsave(file="/home/tim/.local/share/Cryptomator/mnt/Vault/School/MS Thesis/images/heatmapa.tiff",
       plot = methyl_psv_heat,dpi = 600)
# Second
m = cor(sv[,unique(metab_psv_candidates[,1])],psv[,unique(metab_psv_candidates[,2])],
        use = "pairwise.complete.obs")
metab_psv_heat = pheatmap(m,show_rownames = F,show_colnames = F,main = "b",
                          legend_labels = c("0.3","0.2","0.1","0","–0.1","–0.2","–0.3"),
                          legend_breaks = c(0.3,0.2,0.1,0,-0.1,-0.2,-0.3))
ggsave(file="/home/tim/.local/share/Cryptomator/mnt/Vault/School/MS Thesis/images/heatmapb.tiff",
       plot = metab_psv_heat,dpi = 600)
```
...
# Find the probes from enrichment
load('~/Documents/School/MS Thesis/data/mediation/methyl_psv_candidate_pvalues.Rdata')
probes = sapply(strsplit(rownames(methyl_psv_pvalues)," & "),"[[",1)[order(methyl_psv_pvalues$methyl_psv_pvalues)]
entrez = getMappedEntrezIDs(probes[1:100])$sig.eg
probes[grep('3988',entrez)]
```
