...
## Table 3: Reactome Pathway Analysis
...
colnames(t) = c("Pathway","Background","Significant","Expected","Fold Enrichment","p value")
t = t %>% filter(Background >= 5 & Expected >= 2)
