...
The slope of this linear model is significantly different from 1 (p `r format.pval(p,eps = 0.001)`). However, a t test of the difference is not statistically significant (p = `r format.pval(t.test(package-manual)$p.value,eps = 0.001,digits = 3)`). The signs are not all the same, but the one that is different is very close (-0.00323 vs. 0.00209).
...
The slope of this linear model is significantly different from 1 (p `r format.pval(p,eps = 0.001)`). However, a t test of the difference is not statistically significant (p = `r format.pval(t.test(package-manual)$p.value,eps = 0.001,digits = 3)`). All signs are the same.
...
The slope of this linear model is significantly different from 1 (p `r format.pval(p,eps = 0.001)`). However, a t test of the difference is not statistically significant (p = `r format.pval(t.test(package-manual)$p.value,eps = 0.001,digits = 3)`). The signs are pretty different.
...
The slope of this linear model is significantly different from 1 (p `r format.pval(p,eps = 0.001)`). Also, a t test of the difference was statistically significant (p = `r format.pval(t.test(package-manual)$p.value,eps = 0.001,digits = 3)`). The signs are not all the same.
